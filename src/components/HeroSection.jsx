    ...
    return (
        <section>
            <div className='bg-purple dark:bg-dark'>
                <div className='max-w-screen-xl flex flex-col md:flex-row px-5 items-center justify-between py-20 gap-20 m-auto '>
                    <div className='w-full md:w-1/2'>
                        <h6 className='text-pink text-sm'>Best Dress For Your Programs....</h6>
                        <h3 className='text-2xl md:text-5xl  font-bold'>New Fabric Collection Trends in 2025</h3>
                    ...
                    <div className='w-full md:w-1/2'>
                        <img src={bgIMG} className='md:px-20' alt="" />
                    </div>
                </div>
            </div>
        </section>
